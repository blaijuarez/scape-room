    ...
    (e.methods = {
      ...
      setup: function () {
        ...
        e.options.counter && (b += '<div id="quiz-counter"></div>'),
          ...
          (b += '<a href="#" id="quiz-next-btn">Següent</a>'),
          (b += '<a href="#" id="quiz-finish-btn">Comprovar encerts</a>'),
          (b += '<a href="#" id="quiz-restart-btn">Començar</a>'),
          (b += "</div>"),
          (b += "</div>"),
      ...
      gameOver: function (b) {
        if (0 === a(l).length) {
          ...
          (c += '<div id="' + l.substr(1) + '">'),
            ...
            (c += '<p><a href="#" id="quiz-retry-btn">Intentar de nou</a></p>'),
            (c += "</div>"),
            e.$el.append(c);
        }
      ...
      finish: function () {
        e.$el
          ...
          n !== g &&
            a("#quiz-results").html(
              "Has tingut " + n + " encerts de " + g + " preguntes"
            ),
          n !== g && a("#quiz-restart-btn").show(),
          n === g && e.options.finishCallback(),
          n === g && a("#quiz-header").hide();
      },
      restart: function () {
        e.methods.reset(),

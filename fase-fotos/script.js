$(function () {
  ...
  var TOTAL_FOTOS = $container.find(".pd_photo").length;
  var TOTAL_GAZAPOS = $(".pd_photo img[gazapo]").length;
  var navPage = 0;
  var ie = false;
  ...
  function start() {
    ...
    $("<img />").attr("src", "../assets/paperball.png");
    var cntPhotos = 0;
  ...
  function mouseDown($photo) {
    ...
    if (ie) var param = { width: "+=40px", height: "+=40px" };
    else
      var param = {
        width: "+=40px",
        height: "+=40px",
  ...
  $(document).bind("mouseup", function (e) {
    if (mouseup) {
      ...
      $photo
        ...
        .find("img")
        .stop(true, true)
        .animate({ width: "-=40px", height: "-=40px" }, 200);
    }
    e.preventDefault();
  });
  ...
  function stack() {
    ...
    $container.find(".pd_photo").each(function (i) {
      var $photo = $(this);
      $photo
        .css("z-index", parseInt(findHighestZIndex()) + 1000 + i)
        .stop(true)
        .animate(
          {
          ...
          function () {
            ...
            if (cnt_photos == photosSize) enlarge(findElementHighestZIndex());
          }
        );
    });
  }
    ...
    $container.find(".pd_photo").each(function (i) {
      ...
      if ($photo.index() == idxLarge) {
        ...
        $photo
          ...
          .find("img")
          .animate({ width: "170px", height: "170px" }, 500);
      }
    });
  ...
  function bindEvents() {
    ...
    $container
      ...
      .each(function (i) {
        var $photo = $(this);
        $photo
          .draggable({ containment: "#pd_container" })
          .find(".delete")
          .show();
      })
      .find(".pd_hold")
  ...
  function navigate() {
    ...
    var $photo = $container.find(
      ".pd_photo:nth-child(" + parseInt(idxLarge + 1) + ")"
    );
    var r = Math.floor(Math.random() * 201) - 100;
    if (ie)
      var param = {
    ...
    $photo
      ...
      .animate(param, 500, function () {
        ...
        if (navPage < photosSize) enlarge(findElementHighestZIndex());
        else {
  ...
  function shuffle() {
    ...
    $container.find(".pd_photo").each(function (i) {
      var $photo = $(this);
      $photo.css({ width: "170px", height: "170px" });
  ...
  function _compruebaGazapo() {
    var fotos = $container.find(".pd_photo img:visible").length;
    var gazapos = $("#pd_container img[gazapo]").is(":visible");
    fotos === TOTAL_FOTOS - TOTAL_GAZAPOS && !gazapos && final();
    !fotos && shuffle();
  }
});
